            ...
            <div class="col-12 col-sm-12 col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="{{ route('vaksin.index') }}" class="btn btn-primary">View More <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
            ...
            <div class="col-12 col-sm-12 col-lg-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if (Auth::user()->role == 'admin')
                        <div class="card-header-action">
                            <a href="{{ route('pamsimas.index') }}" class="btn btn-primary">View More <i class="fas fa-chevron-right"></i></a>
                        </div>
                        @endif
                    </div>
                    <div class="card-body" style="height:375px;overflow-y:scroll">
